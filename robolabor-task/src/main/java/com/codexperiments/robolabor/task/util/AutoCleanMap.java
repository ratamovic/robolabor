...
// * TODO Comments
// */
// public class AutoCleanDictionary<TKey, TValue> {
// private ConcurrentHashMap<WeakKey<TKey>, WeakValue<TValue>> mMap;
// private ReferenceQueue<TKey> mQueue;
//
// public AutoCleanDictionary() {
// mMap = new ConcurrentHashMap<WeakKey<TKey>, WeakValue<TValue>>();
...
// }
//
// public TValue get(TKey pKey) {
// WeakValue<TValue> lWeakValue = mMap.get(new WeakKey<TKey>(pKey));
